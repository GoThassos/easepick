...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('moment'), require('moment/min/locales'), require('@easepick/datetime')) :
    typeof define === 'function' && define.amd ? define(['exports', 'moment', 'moment/min/locales', '@easepick/datetime'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.easepick = global.easepick || {}, global.moment, global["moment/min/locales"], global.easepick));
})(this, (function (exports, moment, locales, datetime) { 'use strict';
    ...
    class Calendar {
        ...
        getCalendarHeaderView(date) {
            ...
            moment__default["default"].locale(this.picker.options.lang);
            monthName.innerHTML = `<span>${moment__default["default"](date).format('MMMM')}</span> ${date.format('YYYY')}`;
